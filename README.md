...
| 데이터 | 출처 | 기준 시점 |
|---|---|---|
| 집계구 인구·종사자 | SGIS 통계지리정보서비스 | TODO (Phase 1에서 최신 공개 시점으로 확정) |
| 용도지역 | VWorld 토지이용계획정보 | TODO |
| 건축물대장 | 건축HUB | TODO |
| 도로망 | OpenStreetMap | TODO (다운로드 시점) |
| 지하철 네트워크 | 자체 제작 (`subway_network/`, 2026-05-05 export) | `T = 2026-05-04` (`03_isochrone.py`) |

### 구역계 (Phase 0 확정 — 상세는 [PLAN.md](PLAN.md) §1 참고)
- 판교테크노밸리(제1판교): 661,157㎡, 핵심역 판교역(신분당선)
- 청라국제업무지구: 278,000㎡(가구역+나구역), 핵심역 청라국제도시역(공항철도)
