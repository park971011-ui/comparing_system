...
- 청라국제업무지구: 278,000㎡(가+나구역), 공항철도 청라국제도시역(126.62465, 37.55649) 인근.
  법적 근거(확인됨): 인천광역시경제자유구역청고시 제2024-431호(2024.12.30.) "인천경제자유구역
  청라국제도시 개발계획 변경, 실시계획(2-①~2-④단계) 변경 승인 및 지형도면 고시" — 판교와
  동일하게 개별 지구단위계획 단독고시가 아니라 광역 개발/실시계획 변경 고시에 포함된 형태.
  결정도면 좌표는 미확보. (eum.go.kr seq=519197 은 무관한 고시로 판명되어 인용 취소함)
