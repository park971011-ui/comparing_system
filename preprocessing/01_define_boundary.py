...
방법론 (2026-06-24, 시간 제약상 임시 채택):
국토부 NSDI/UPIS 지구단위계획구역 API는 data.go.kr 별도 활용신청이 필요해
1~2일 승인 대기가 발생한다. 정식 고시 polygon 확보 전까지, PLAN.md §1-2에 명시된
"공식 면적 수치"에 맞춘 **면적-일치 근사 사각형**을 핵심역 인근에 배치해 임시 경계로 쓴다.

- 판교테크노밸리: 661,157㎡, 신분당선 판교역(127.11116, 37.39457) 북쪽 삼평동 일원
- 청라국제업무지구: 278,000㎡(가+나구역), 공항철도 청라국제도시역(126.62465, 37.55649) 인근

주의: 이 polygon은 정식 지구단위계획 고시 경계가 아니라 "면적-일치 근사치"다.
보고서에는 반드시 "실제 고시 경계가 아닌 면적 기준 근사 경계(출처: PLAN.md §1-2의 공식
면적 수치)"임을 명시할 것. 정식 polygon 확보 시 이 스크립트를 교체한다.
