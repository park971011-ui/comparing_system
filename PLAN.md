...
| 청라국제업무지구 | 청라국제도시 내 국제업무지구(B1·B2·B9·B10·C1·C2·M5·M6 일원), 가구역+나구역 | 278,000㎡ (가구역 144,000㎡ + 나구역 134,000㎡) | IFEZ 지구단위계획 청라국제도시 국제업무지구(plan_se=C03015). ~~토지이음 고시(eum.go.kr seq=519197)~~ — **정정: 이 seq는 무관한 고시("도청수용지구개발사업", 2022)로 확인되어 인용 취소.** 정식 결정고시 번호 미확인 (Phase 0 잔여 TODO) |
